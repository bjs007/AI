...
from agent_bsharma import *
#from agents import Agent_bsharma
...
if __name__ == '__main__':
   ...
   #data_groups = ["dataset3"]
    for data_group in data_groups:
        ...
        agents.append(Agent_single_sklearn("svc", SVC(probability=True,kernel='poly',degree=4,random_state=0)))
        # Add your own agent; change mbilgic to your own hawk id
        agents.append(Agent_bsharma("bsharma"))
